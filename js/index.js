...
// Create a "Blog" nav link (and make it the last link)

const blogLink = document.createElement("a");
blogLink.href = "#";
blogLink.textContent = "Blog";
navContent.appendChild(blogLink);
...
buttonText.style.border = "2px solid darkturquoise";
...
footerP.style.color = "darkturquoise";
